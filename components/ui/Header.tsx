...
export default async function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 bg-vt-maroon w-full border-b border-b-slate-200 shadow-sm">
      <div className="bg-vt-maroon h-16 py-4 container mx-auto">
        <nav className="flex justify-between mx-10">
          ...
          >
            {/* <Logo /> */}
            <span className="text-white text-2xl mb-2 font-medium">HokieGPT</span>
          </Link>
          <div className="flex items-center gap-5">
            {isLoggedIn ? (
              <>
                <Link href="/dashboard" className='text-white font-medium'>PDF Menu</Link>
